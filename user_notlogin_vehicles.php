<?php
//because no user has login and when the user click "View details" this page is open
//cannot view the details for the vehicles and make an rental because no user logged in
...
<center>
    <span style="font-size:20px;"> FOR MORE DETAILS</span></div>

    <div><a href="login.php" class="bn62">Login</a></div>
</center>
